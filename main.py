...
async def profile(interaction: discord.Interaction):
    ...
    embed.add_field(name="<:hp_heart:1521868611524759704> **HP**  <:mp_heart:1521868748431163492> **MANA**     🎭 **SAN**", value=f"`{u['hp']}/{u['hp_max']}` | `{u['mana']}/{u['mana_max']}` | `{u['san']}/{u['san_max']}`", inline=True)
    ...
    embed.add_field(name="🟥 **STR**  🟧 **VIT**  🟨 **AGI**", value=f"ㅤㅤㅤ`{u['str']}`ㅤㅤㅤㅤ`{u['vit']}`ㅤㅤㅤㅤ`{u['agi']}`", inline=False)
    # if is_new:
